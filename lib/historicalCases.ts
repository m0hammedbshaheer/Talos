...
export type CitationForComparison = {
  /** This reference is known retracted / fraudulent */
  retracted?: boolean;
  /** Part of a citation cascade (e.g. cites retracted or problematic work) */
  cascade?: boolean;
};
...
/**
 * Map an integrity score and per-citation risk flags to a severity tier and
 * the closest historical scandal for storytelling.
 */
