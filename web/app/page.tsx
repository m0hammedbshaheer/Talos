      ...
      <div className="rw-landing-shell rw-bg rw-grid">
        ...
        <div className="relative z-10">
          ...
          <div
            ...
            className={`group relative mt-8 cursor-pointer select-none overflow-hidden rounded-2xl border-2 border-dashed p-10 text-center transition-all duration-300 ${
              drag
